                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><i class="fas fa-shopping-bag"></i>Tổng Số Sản Phẩm</div>
												<h2><?= COUNT($object) ?></h2>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body"><i class="fas fa-user-alt"></i>Tổng Số Khách Hàng</div>
												<h2><?= COUNT($objects) ?></h2>
                                    <!-- <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><i class="far fa-calendar-alt"></i>Tổng Số Danh Mục</div>
												<h2><?= COUNT($objs) ?></h2>
                                    <!-- <div class="card-footer d-flex align-items-center justify-content-between">
                                ...
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"><i class="fas fa-sort-amount-down-alt"></i>Tổng Số Đơn Hàng</div>
												<h2><?= 0 ?></h2>
													<!-- <div class="card-footer d-flex align-items-center justify-content-between">
