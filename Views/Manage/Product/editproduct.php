...
<body id="page-top">
   ...
   <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <li class="nav-item">
            <a class="nav-link collapsed" href="index.php?controllers=catagory&action=catagoryproduct" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
               ...
               <div class="container">
                  ...
                  <div class="form-group">
                     <label>Danh Mục</label>
                        <select name="catalog" class="form-control" required>     
                            ...
                            <?php foreach ($objects as $object): ?>      
                              <option <?=  $object->id == $obj->catalog ? "selected" :  " "?>
                                value="<?php echo $object->id?>"><?php echo $object->name; ?></option>
                              <?php endforeach; ?> 
                     </select> 
                     </div>  
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo $obj->name; ?>">
                     </div>
                     <div class="form-group">
                        <label>Giá</label>
                        <input type="text" name="price" class="form-control" value="<?php echo $obj->price; ?>">
                     </div>
                     <div class="form-group">
                        <label>Số Lượng</label>
                        <input type="text" name="quantity" class="form-control" value="<?php echo $obj->quantity; ?>">
                     </div>
                     <div class="form-group">
                        <label>Ảnh</label>
                        <input type="file" name="image" class="form-control" value="<?php echo $obj->image; ?>" required>
                     </div>
                     <div class="form-group">
                        <label>Mô Tả</label>
                        <input type="text" name="description" class="form-control" value="<?php echo $obj->description; ?>">
                     </div>
                     <button type="submit" class="btn btn-primary">Cập nhật sản phẩm</button>
                     <a class="btn btn-primary" href="index.php?controllers=manage&action=product">Quay Lại</a>
                  </form>
               </div>
</body>
