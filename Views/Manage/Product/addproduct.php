            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  ...
                  <label>Danh Mục</label>
                     ...
                     <div class="form-group">
                        <label>Ảnh</label>
                        <input type="file" name="image" class="form-control" placeholder="Thêm ảnh sản phẩm" required>
                     </div>
                     <div class="form-group">
                        <label>Mô Tả</label>
                        <input type="text" name="description" class="form-control" placeholder="Nhập mô tả sản phẩm" required>
                     </div>
