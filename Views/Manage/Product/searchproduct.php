      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  <a class="btn btn-info" href="index.php?controllers=manage&action=add">Thêm sản phẩm</a>
                  <table>
                                 ...
                                 <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-footer justify-content-center">
                                          <a class="btn btn-danger mr-auto" href="index.php?controllers=manage&action=delete&id=<?php echo $obj->id ?>">Xóa</a>
