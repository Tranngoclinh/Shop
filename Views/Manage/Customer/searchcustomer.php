      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                  <h6 class="collapse-header"></h6>
                  <a class="collapse-item" href="utilities-color.html"> Báo Cáo Đơn Hàng</a>
                  <a class="collapse-item" href="utilities-border.html">Báo Cáo Sản Phẩm</a>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
               ...
               <!-- Topbar Search -->
               <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="index.php?controllers=managecustomer&action=searchcustomer" method="post">
            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  <a class="btn btn-info" href="index.php?controllers=managecustomer&action=addcustomer">Thêm Khách Hàng</a>
                  ...
                  <table>
                     ...
                     foreach ($objects as $key => $obj) : ?> 
                        <tr>
                           ...
                           <a class="" href="index.php?controllers=catagory&action=editcatagory&id=<?php echo $obj->id ?>"><i class='fas fa-edit fa-lg text-warning'></i></a>
                                 <!-- <a class="btn btn-danger" href="index.php?controllers=manage&action=delete&id=<?php echo $obj->id ?>" onclick='return confirm("Bạn có chắc muốn xóa")'>Xóa</a> -->
                                 ...
                                 <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-footer justify-content-center">
                                          <a class="btn btn-danger mr-auto" href="index.php?controllers=managecustomer&action=deletecustomer&id=<?php echo $obj->id ?>">Xóa</a>
                     ...
                     <?php endforeach;
                   elseif(!isset($objects) && empty($search)): echo 'Không tìm thấy Khách Hàng';
                   else: echo 'Không Tìm Thấy Khách Hàng';
