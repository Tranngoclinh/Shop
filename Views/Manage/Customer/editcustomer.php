            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Địa Chỉ</label>
                        <input type="text" name="address" class="form-control" value="<?php echo $obj->address ?>">
                     </div>
                     <button type="submit" class="btn btn-primary">Cập nhật</button>
                     <a class="btn btn-primary" href="index.php?controllers=managecustomer&action=customer">Quay Lại</a>
                  </form>
               </div>
</body>
