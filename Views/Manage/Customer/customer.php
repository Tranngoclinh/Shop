                     ...
                     <table border="1px">
                        ...
                        <?php foreach ($object as $key => $obj) : ?>
                           <tr>
                              ...
                              <td>
                                 <a class="" href="index.php?controllers=managecustomer&action=editcustomer&id=<?php echo $obj->id ?>"><i class='fas fa-edit fa-lg text-warning'></i></a>
