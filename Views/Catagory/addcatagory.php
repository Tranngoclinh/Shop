            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  ...
                  <!-- <div class="form-group">
                        <label>ID</label>
                        <input type="text" name="id" class="form-control" placeholder="Nhập danh mục" required>
                     </div> -->
                     <div class="form-group">
                        <label>Tên Danh Mục</label>
                        <input type="text" name="namecatagory" class="form-control" placeholder="Nhập tên sản phẩm" required>
                     </div>
