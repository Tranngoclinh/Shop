      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
               ...
               <!-- Topbar Search -->
               <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="index.php?controllers=catagory&action=searchcatagory" method="post">
            ...
            <div class="container-fluid">
               ...
               <div class="container">
                  <a class="btn btn-info" href="index.php?controllers=manage&action=add">Thêm Danh Mục</a>
                  <table>
                                 ...
                                 <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-footer justify-content-center">
                                          <a class="btn btn-danger mr-auto" href="index.php?controllers=catagory&action=deletecatagory&id=<?php echo $obj->id ?>">Xóa</a>
                     ...
                     <?php endforeach;
                     elseif(!isset($objects) && empty($search)): echo 'Không tìm thấy sản phẩm';
