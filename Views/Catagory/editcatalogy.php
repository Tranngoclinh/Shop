               ...
               <div class="container">
                  <form action="" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="catagory" class="form-control" value="<?php echo $obj->name; ?>">
                     </div>
                     <button type="submit" class="btn btn-primary">Cập nhật danh mục</button>
                     <a class="btn btn-primary" href="index.php?controllers=catagory&action=catagoryproduct">Quay Lại</a>
                  </form>
               </div>
</body>
