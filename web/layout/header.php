						...
						<div class="logo-nav-left1">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									<li class="active"><a href="indexshop.php?controllers=home&action=homeshop" class="act">Trang Chủ</a></li>	
									<!-- Mega Menu -->
									<li class="dropdown">
											...
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6></h6>
														<li><a href="products.php">Quần áo</a></li>
														<li><a href="products.php">Trang Sức</a></li>
														<li><a href="products.php">Giày</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6></h6>
														<li><a href="products.php">Kính</a></li>
														<li><a href="products.php">Túi</a></li>
											...
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6></h6>
														<li><a href="products.php">Quần áo</a></li>
														<li><a href="products.php">Ví</a></li>
														<li><a href="products.php">Giày</a></li>
